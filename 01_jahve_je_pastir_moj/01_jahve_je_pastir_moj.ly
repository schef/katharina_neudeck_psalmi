...
%% <- /museScore/Score/metaTag
%% -> /museScore/Score/metaTag' text="2023-05-31"' attr="{'name': 'creationDate'}"
%% <- /museScore/Score/metaTag
...
%% -> /museScore/Score/Staff/VBox/Text/text' text="Jahve je pastir moj"'
%% <- /museScore/Score/Staff/VBox/Text/text
%% <- /museScore/Score/Staff/VBox/Text
%% -> /museScore/Score/Staff/VBox/Text''
%% -> /museScore/Score/Staff/VBox/Text/style' text="Lyricist"'
%% <- /museScore/Score/Staff/VBox/Text/style
%% -> /museScore/Score/Staff/VBox/Text/text' text="Psalam 23"'
%% <- /museScore/Score/Staff/VBox/Text/text
%% <- /museScore/Score/Staff/VBox/Text
%% -> /museScore/Score/Staff/VBox/Text''
%% -> /museScore/Score/Staff/VBox/Text/style' text="Composer"'
%% <- /museScore/Score/Staff/VBox/Text/style
%% -> /museScore/Score/Staff/VBox/Text/text' text="Katharina Neudeck"'
%% <- /museScore/Score/Staff/VBox/Text/text
%% <- /museScore/Score/Staff/VBox/Text
%% -> /museScore/Score/Staff/VBox/Text''
%% -> /museScore/Score/Staff/VBox/Text/style' text="Instrument Name (Part)"'
%% <- /museScore/Score/Staff/VBox/Text/style
%% -> /museScore/Score/Staff/VBox/Text/text' text="1"'
%% <- /museScore/Score/Staff/VBox/Text/text
%% <- /museScore/Score/Staff/VBox/Text
%% <- /museScore/Score/Staff/VBox
...
%% -> /museScore/Score/Staff/Measure/voice/Tempo/tempo' text="1.0833333333333333"'
%% <- /museScore/Score/Staff/Measure/voice/Tempo/tempo
%% -> /museScore/Score/Staff/Measure/voice/Tempo/offset'' attr="{'x': '-11.6129', 'y': '2.91935'}"
%% <- /museScore/Score/Staff/Measure/voice/Tempo/offset
%% -> /museScore/Score/Staff/Measure/voice/Tempo/text' text="= 65"'
...
%% -> /museScore/Score/Staff/Measure/voice/RehearsalMark/minDistance' text="0.348327"'
%% <- /museScore/Score/Staff/Measure/voice/RehearsalMark/minDistance
%% -> /museScore/Score/Staff/Measure/voice/RehearsalMark/offset'' attr="{'x': '-3.77419', 'y': '-2.54645'}"
%% <- /museScore/Score/Staff/Measure/voice/RehearsalMark/offset
%% -> /museScore/Score/Staff/Measure/voice/RehearsalMark/text' text="Refren"'
...
%% -> /museScore/Score/Staff/Measure/voice/Harmony/base' text="14"'
...
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/text' text="stir"'
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/text
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% -> /museScore/Score/Staff/Measure/voice/Chord/Note''
%% -> /museScore/Score/Staff/Measure/voice/Chord/Note/pitch' text="64"'
...
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/ticks_f' text="2/32"'
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/ticks_f
...
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/ticks
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/ticks_f' text="4/16"'
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/ticks_f
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/text' text="moj"'
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/text
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics
...
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic' text="middle"'
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/text' text="dije"'
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/text
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% -> /museScore/Score/Staff/Measure/voice/Chord/Note''
%% -> /museScore/Score/Staff/Measure/voice/Chord/Note/pitch' text="62"'
...
%% <- /museScore/Score/Staff/Measure/voice/Harmony
%% -> /museScore/Score/Staff/Measure/voice/RehearsalMark''
%% -> /museScore/Score/Staff/Measure/voice/RehearsalMark/text' text="Kitica"'
%% <- /museScore/Score/Staff/Measure/voice/RehearsalMark/text
%% <- /museScore/Score/Staff/Measure/voice/RehearsalMark
%% -> /museScore/Score/Staff/Measure/voice/Chord''
%% -> /museScore/Score/Staff/Measure/voice/Chord/durationType' text="16th"'
...
%% -> /museScore/Score/Staff/Measure/voice/Harmony/root' text="14"'
%% <- /museScore/Score/Staff/Measure/voice/Harmony/root
%% -> /museScore/Score/Staff/Measure/voice/Harmony/base' text="18"'
%% <- /museScore/Score/Staff/Measure/voice/Harmony/base
%% <- /museScore/Score/Staff/Measure/voice/Harmony
%% -> /museScore/Score/Staff/Measure/voice/Chord''
%% -> /museScore/Score/Staff/Measure/voice/Chord/durationType' text="quarter"'
...
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic' text="begin"'
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/text' text="od"'
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/text
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% -> /museScore/Score/Staff/Measure/voice/Chord/Note''
%% -> /museScore/Score/Staff/Measure/voice/Chord/Note/pitch' text="62"'
...
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic' text="begin"'
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/text' text="krije"'
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/text
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% -> /museScore/Score/Staff/Measure/voice/Chord/Note''
%% -> /museScore/Score/Staff/Measure/voice/Chord/Note/pitch' text="65"'
...
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/ticks_f' text="0/16"'
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/ticks_f
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/text' text="pi"'
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/text
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% -> /museScore/Score/Staff/Measure/voice/Chord/Note''
%% -> /museScore/Score/Staff/Measure/voice/Chord/Note/pitch' text="64"'
...
%% -> /museScore/Score/Staff/TBox/Text/text' text="2.    \nDa mi je dolinom smrti proći,\nzla se ne bojim, jer si sa mnom.\nTvoj štap i palica tvoja\nutjeha su meni.\n    \n3.\nTrpezu preda mnom prostireš,\nna oči dušmanima mojim.\nUljem mi glavu mažeš,\nčaša se moja prelijeva.\n    \n4.\nDobrota i milost me prate\nsve dane života moga.\nU domu ću tvome biti\nkroz dane mnoge."'
