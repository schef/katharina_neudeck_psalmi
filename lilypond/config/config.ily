...
%%%%%%%%%%%%%%%%%%%%%%%%%
      ...
      \override BreathingSign.color = #(rgb-color 0.580 0.157 0.239)
    }
    ...
    \context {
      ...
      \override RehearsalMark.color = #(rgb-color 0.580 0.157 0.239)
    }
  }
  ...
  breathemoj = {
    ...
    \once \override Staff.BarLine.color = #(rgb-color 0.580 0.157 0.239)
...
%%%%%%%%%%%%
  ...
  aFourL = \paper {
    bookTitleMarkup = \markup {
      ...
      \fill-line {
        %rasiri po liniji u stupce na rubove
        \line {
          %stvori lijevu grupu stupaca
          \column %prvi lijevi stupac
          {
            \vspace #1.5 %pomiče znak prema dole
            { \override #'(font-name . "JohnSans Medium Pro") \override #'(font-size . 13) \with-color #(rgb-color 0.580 0.157 0.239) \fromproperty #'header:broj }
          }
        ...
        \right-column {
          ...
          \line {
            %stvori novu liniju unutar donjeg dijela stupca da dobimo odnos 1:n
  ...
  aFourR = \paper {
    bookTitleMarkup = \markup {
      ...
      \fill-line {
        ...
        \left-column {
          %drugi lijevi stupac s lijevim poravnavanjem
          \when-property #'header:composer {
            \override #'(font-name . "JohnSans White Pro") \override #'(font-size . 1.5) \with-color #black { \fromproperty #'header:composer }
          }
          \line {
