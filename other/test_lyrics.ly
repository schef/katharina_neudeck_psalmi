...
%% Lyrics(text='bok', syllabic='', ticks='960', ticks_f='1/2', no='')
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/ticks text="960"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/ticks
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/ticks_f text="1/2"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/ticks_f
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/text text="bok"
...
%% ChordNoteSpanner(type='Tie', next_location_fractions='-3/4', prev_location_fractions='')
...
%% -> /museScore/Score/Staff/Measure/voice/Chord/Note
%% -> /museScore/Score/Staff/Measure/voice/Chord/Note/Spanner attr="{'type': 'Tie'}"
%% ChordNoteSpanner(type='Tie', next_location_fractions='', prev_location_fractions='3/4')
...
\score {
    ...
    \new Staff { \staffOne }
    \new Lyrics \with { associatedVoice = "vocals" } { \lyricOneZero }
    >>
}
